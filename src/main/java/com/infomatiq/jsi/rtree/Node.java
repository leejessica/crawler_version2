...
public class Node {
	...
	public float mbrMaxX = -Float.MAX_VALUE;
	public float mbrMaxY = -Float.MAX_VALUE;

	public float[] entriesMinX = null;
	public float[] entriesMinY = null;
	public float[] entriesMaxX = null;
	public float[] entriesMaxY = null;
